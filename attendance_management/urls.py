...
router.register(r'events', EventAttendanceViewSet, basename='event-attendance')
router.register(r'', AttendanceViewSet, basename='attendance')  # Register with empty prefix
